...
const ImageList = [
  {
    ...
    description:
"Experience the future of timekeeping with the Next Generation Blue Watch, blending cutting-edge technology and timeless style for those who value precision and elegance."
  },
  {
    id: 2,
    img: watch2,
    ...
    description:
      "Experience the perfect blend of style and innovation with our smart yellow watch. Designed to elevate your look and keep you connected seamlessly.",
  },
  {
    id: 3,
    img: watch3,
    ...
    description:
      "Experience the ultimate blend of innovation and style with the Apple Ultra Smart Watch 2. Designed for performance, durability, and unmatched functionality, its your perfect companion for fitness and everyday life",
  },
];
